...
module.exports = {
    VERSION: 'v4.0.0',
    ALIVE: process.env.ALIVE || "https://i.ibb.co/GJBtWkR/Ephoto360-com-166f82b16bd615.jpg Hey {sender}, I'm alive \n Uptime: {uptime}",
    ...
    ANTI_SPAM: process.env.ANTI_SPAM || '923328025808-1632403322@g.us',
    ...
    SESSION: (process.env.SESSION || process.env.SESSION_ID || 'Raganork~2f43d9bffc7d1905d3c1741d897bd3d2:377665327834724b6f6d6f3d').trim() || '',
    ...
    STICKER_DATA: process.env.STICKER_DATA || "Nightmare",
    BOT_NAME: process.env.BOT_NAME || 'Nightmare',
    AUDIO_DATA: process.env.AUDIO_DATA === undefined || process.env.AUDIO_DATA === "private" ? 'Nightmare;Bot;https://i.ibb.co/GJBtWkR/Ephoto360-com-166f82b16bd615.jpg' : process.env.AUDIO_DATA,
