...
module.exports = {
    ...
    STICKER_DATA: process.env.STICKER_DATA || "Ragnarok",
    BOT_NAME: process.env.BOT_NAME || 'Ragnarok',
    AUDIO_DATA: process.env.AUDIO_DATA === undefined || process.env.AUDIO_DATA === "private" ? 'Ragnarok;Bot;https://i.ibb.co/GJBtWkR/Ephoto360-com-166f82b16bd615.jpg' : process.env.AUDIO_DATA,
